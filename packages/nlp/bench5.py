...
df = pd.read_csv(OUT / "EfSearchResultsFinal.csv")
...
ax.set_xlabel('efSearch', fontsize=10)
...
save(fig, 'efsearch_accuracy.png')
...
save(fig, 'efsearch_build_time.png')
...
save(fig, 'efsearch_query_latency.png')